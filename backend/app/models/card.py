...
class Card(Base):
    ...
    company_preset: Mapped[CompanyPreset | None] = relationship("CompanyPreset", lazy="joined")
    barcode_type: Mapped[BarcodeType | None] = relationship("BarcodeType", lazy="joined")